...
export default function Portfolio() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: "url('/images/9a05921b-e911-47c3-8e27-fc24776cbc99.png')",
      ...
      <header className="sticky top-0 z-50 border-b bg-background/80 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <a aria-label="Instagram" href={LINKS.instagram} target="_blank" rel="noreferrer" className="rounded-md p-2 hover:bg-muted">
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button asChild variant="ghost" size="sm"><a href={LINKS.instagram} target="_blank" rel="noreferrer" className="gap-2 inline-flex items-center"><Instagram className="h-4 w-4" />Instagram</a></Button>
            </div>
          </div>
        </div>
      </footer>
